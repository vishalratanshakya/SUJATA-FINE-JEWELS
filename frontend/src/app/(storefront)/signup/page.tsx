...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      toast.success("Account created successfully! Welcome to Sujata Fine Jewels.");
      router.push("/account");
    }, 1200);
  };
  ...
  return (
    <div className="min-h-screen bg-[#EBE7E0] p-4 sm:p-6 lg:p-8 flex items-center justify-center font-sans">
      <div className="w-full max-w-5xl bg-[#FAF8F5] rounded-2xl border border-[#DCD4C7] shadow-xl overflow-hidden grid grid-cols-1 lg:grid-cols-12 min-h-[660px] relative">
        ...
        {/* ── LEFT PANEL: Luxury Brand Visual ── */}
        <div className="lg:col-span-5 relative flex flex-col justify-between p-8 lg:p-12 bg-[#F2EDE4] overflow-hidden pt-16 lg:pt-16 min-h-[500px]">
          ...
          <div className="absolute inset-0 z-0">
            <Image
              src="/images/auth/signup_pendant.jpg"
              alt="Sujata Fine Jewels Diamond Pendant"
              fill
              priority
          ...
          <div className="relative z-10 space-y-6 text-center mt-2">
            ...
            <div className="space-y-3 px-2">
              <h3 className="font-serif text-3xl lg:text-4xl text-[#1F1B18] font-normal leading-tight drop-shadow-xs">
                Begin Your<br />
                <span className="italic font-light text-[#9A7A4C]">Journey of Elegance</span>
              </h3>
              <p className="text-xs text-[#4A433A] font-medium leading-relaxed max-w-xs mx-auto font-sans">
                Create your account and discover a world of timeless beauty.
              </p>
            </div>
          </div>
          ...
          <div className="relative z-10 pt-4 text-center mt-auto">
            <p className="text-[10px] uppercase tracking-[0.25em] text-[#2C2825] font-semibold font-mono bg-white/60 backdrop-blur-xs py-1 px-3 rounded-full inline-block border border-white/80 shadow-xs">
              PURE 18K GOLD • CERTIFIED DIAMONDS
            </p>
          </div>
        </div>

        {/* ── RIGHT PANEL: User Sign Up Form ── */}
          ...
          <div className="max-w-md w-full mx-auto space-y-5">
            ...
            <form onSubmit={handleSubmit} className="space-y-3.5">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full bg-[#FFFFFF] border pl-11 pr-4 py-2.5 text-sm text-[#2C2825] rounded-xl focus:outline-none transition-all ${
                      errors.fullName
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full bg-[#FFFFFF] border pl-11 pr-11 py-2.5 text-sm text-[#2C2825] rounded-xl focus:outline-none transition-all ${
                      errors.password
                        ? "border-rose-400 focus:border-rose-500 bg-rose-50/20"
                        : "border-[#E2DDD3] focus:border-[#2C2825] focus:ring-1 focus:ring-[#2C2825]"
                    }`}
                ...
                {password && (
                  <div className="mt-1.5 flex items-center space-x-2">
                    <div className="flex-1 h-1.5 bg-[#E8E2D8] rounded-full overflow-hidden flex space-x-1 p-0.5">
                    ...
                    <span className="text-[11px] font-semibold text-[#6B6357] uppercase tracking-wider">
                      {strength.label}
                    </span>
                  </div>
                )}
              ...
              <div>
                <div className="flex items-start">
                  <input
                    ...
                    className="mt-0.5 h-4 w-4 rounded border-[#E2DDD3] text-[#2C2825] focus:ring-[#2C2825] cursor-pointer"
                  />
                  <label htmlFor="agree-terms" className="ml-2.5 text-xs text-[#6B6357] leading-tight cursor-pointer">
                    I agree to the{" "}
                    <Link href="/terms" className="text-[#A38350] hover:underline font-medium">
                      Terms & Conditions
                    </Link>{" "}
                    and{" "}
                    <Link href="/privacy" className="text-[#A38350] hover:underline font-medium">
                      Privacy Policy
                    </Link>
                  </label>
                </div>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-[#B38E5D] hover:bg-[#997746] text-[#FAF8F5] text-xs font-semibold uppercase tracking-[0.2em] py-3 rounded-xl transition-all duration-300 shadow-md hover:shadow-lg disabled:opacity-70 flex items-center justify-center space-x-2 mt-3"
              >
                {isLoading ? (
            ...
            <div className="grid grid-cols-2 gap-3">
              <GoogleLoginButton
                ...
                className="bg-white border border-[#E2DDD3] hover:border-[#2C2825] text-[#2C2825] text-xs font-medium py-2.5 rounded-xl transition-all duration-300 flex items-center justify-center space-x-2 shadow-xs cursor-pointer"
              />

              <button
                type="button"
                onClick={() => toast.error("Apple sign up currently unavailable")}
                className="bg-white border border-[#E2DDD3] hover:border-[#2C2825] text-[#2C2825] text-xs font-medium py-2.5 rounded-xl transition-all duration-300 flex items-center justify-center space-x-2 shadow-xs"
              >
