...
export default function CreateCollectionPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    addCollection({
      ...
      tagline,
      description,
      image: image || "/images/collections/bridal.jpg",
      productsCount: 0,
    });
  ...
  return (
    <div className="max-w-4xl space-y-8">
      <div>
        ...
        <h1 className="text-2xl font-serif text-gray-900">Create New Collection</h1>
        <p className="text-xs text-gray-500 mt-1">Design a new curated showcase line for high jewellery</p>
      </div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <input 
              ...
              placeholder="e.g. Royal Solitaire Collection"
          ...
          <div>
            ...
            <input 
              ...
              placeholder="e.g. Timeless Diamonds Crafted for Royalty"
              className="w-full px-4 py-2.5 border border-gray-200 rounded text-sm focus:outline-none focus:border-charcoal"
            />
          </div>
          ...
          <div>
            ...
            <textarea 
              ...
              placeholder="Detailed story about this curated collection line..."
              className="w-full px-4 py-2.5 border border-gray-200 rounded text-sm focus:outline-none focus:border-charcoal"
            />
          </div>
